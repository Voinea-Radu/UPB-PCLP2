 ...
 *
 * @param function   A function that takes two pointers, the first void *
 * will be the element of the new array,
 * the second void will be the element of the array.
 * @param new_list_element_size  The size of a single element of the new array.
 ...
 *
 * @param function  A function that takes a pointer to an element of the array
 * and returns a boolean.
 * @param list  The array to be iterated.
 * @return      A new list with the elements of the original array that
 * satisfy the given function.
 */
array_t filter(boolean(*function)(void *elem), array_t list);
 ...
 *
 * @param function   A function that takes two pointers, the first pointer
 ...
 * elements of the arrays, of size varg_count.
 ...
 * @return Last value of the accumulator.
 */
void *reduce_multiple(void (*function)(void *, void **),
					  void *accumulator, int varg_count, ...);
