...
apply_sbox: ;; apply_sbox(uint8 value)
    push ebp
    mov ebp, esp
    pusha
...
apply_left_rotation: ;; apply_left_rotation(uint8 value)
    push ebp
    mov ebp, esp
    pusha
...
apply_right_rotation: ;; apply_right_rotation(uint8 value)
    push ebp
    mov ebp, esp
    pusha
